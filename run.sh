...
# venv/bin/python3 src/main_net.py --mode train --root_dir local_data_bodyframe/Euroc/ --window_time=2 --out_dir models_mlp/resnet/ --epochs 300 --arch resnet --input_dim 6 --body_frame True 

## this one needs revisiting the eq network
# venv/bin/python3 src/main_net.py --mode train --root_dir local_data_bodyframe/Euroc/ --window_time=2 --out_dir models_eq/ln_conv_last_align_notcomp_2regress_nochannelmix_slope_1_largechannel_onechannelmix_mselss_nobias_ep300/ --epochs 300 --arch ln_resnet --input_dim 6 --body_frame True 
