...
class SO3EquivariantReluBracketLayers(nn.Module):
    def __init__(self, 
        ...
        self.map_m_to_m1 = LNLinear_VNBatch_KillingRelu(self.first_out_channel//div,self.first_out_channel//div,algebra_type='so3')
        # self.map_m_to_m2 = LNLinear_VNBatch_KillingRelu(256//div,256//div,algebra_type='so3')
