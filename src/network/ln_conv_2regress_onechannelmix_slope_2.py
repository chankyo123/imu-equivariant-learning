...
class LN_BasicBlock1D(nn.Module):
    ...
    def __init__(self, in_planes, planes, stride=1, downsample=None):
        ...
        self.relu = VNLeakyReLU(planes,negative_slope=0.2)
...
class FcBlock(nn.Module):
    def __init__(self, in_channel, out_channel, in_dim):
        ...
        self.relu = VNLeakyReLU(self.fc_dim,negative_slope=0.2)
...
class SO3EquivariantReluBracketLayers(nn.Module):
    def __init__(self, 
        ...
        self.map_m_to_m0 = LNLinear_VNBatch_VNRelu(self.first_out_channel//div,self.first_out_channel//div, negative_slope=0.2)
    ...
    def forward(self, x):
        ...
        m0 = self.map_m_to_m0(x)
        M0 = torch.einsum("b f k d, b k e d -> b f e d", m0, m0.transpose(1,2))
        x = torch.einsum("b f k d, b k e d -> b f e d", M0,x)
